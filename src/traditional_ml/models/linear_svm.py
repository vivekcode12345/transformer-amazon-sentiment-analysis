...
def train_linear_svm(
    ...
    random_state: int = 42,
    clean: bool = True,
) -> Tuple[LinearSVC, Any, Any, Any, Any, Dict[str, Any]]:
    """
    ...
    Example:
        >>> model, X_train, X_test, y_train, y_test, metrics = train_linear_svm()
        >>> print(f"Accuracy: {metrics['accuracy']:.2%}")
    """
    
    print("\n" + "=" * 70)
    print("LINEAR SVM - TRAINING PIPELINE")
    print("=" * 70)
    ...
    # =========================================================================
    # STEP 2: Initialize the Linear SVM model
    # =========================================================================
    print("\n[Step 2/6] Initializing Linear SVM model...")
    print(f"   Configuration: {LINEAR_SVM_CONFIG}")
    
    # Create the model with our hyperparameters
    model = LinearSVC(**LINEAR_SVM_CONFIG)
    
    print(f"   Model: {model.__class__.__name__}")
    print(f"   Regularization (C): {LINEAR_SVM_CONFIG['C']}")
    print(f"   Loss function: {LINEAR_SVM_CONFIG['loss']}")
    print(f"   Class weight: {LINEAR_SVM_CONFIG['class_weight']}")
    ...
    # The model learns the optimal hyperplane to separate positive and negative reviews
    ...
    metrics = evaluate_linear_svm(y_test, y_pred, decision_scores)
    ...
    print("=" * 70)
    print("\nYou can now:")
    print("1. Load the model: model = joblib.load('models/traditional_ml/linear_svm/model.pkl')")
    print("2. Make predictions: model.predict(new_tfidf_features)")
    print("3. View metrics: reports/linear_svm_metrics.json")
    print("=" * 70)
